...
def proc_work(fpath_stndb, elem, ngh_rng, rank):
    ...
    optim = XvalTairNorm(fpath_stndb, elem)
    ...
    while 1:
        ...
        if status.tag == TAG_STOPWORK:
            ...
            try:
                ...
                err = optim.run_xval(stn_id, ngh_rng)
                MPI.COMM_WORLD.send((stn_id, err), dest=RANK_WRITE,
                                    tag=TAG_DOWORK)
...
if __name__ == '__main__':
    ...
    path_out_optim = twx_cfg.path_interp_optim_norms
